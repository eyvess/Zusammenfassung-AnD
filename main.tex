...
%% ERGÄNZUNGEN ERSTELLEN GEORG WEEK 3 => WEEK 4
  ...
  \end{equation}
    ...
    $\mathcal{O}(1) \leqslant [\mathcal{O}(\frac{1}{n^2}) \leqslant \mathcal{O}(\frac{1}{n}) \leqslant \ ] \  \mathcal{O}(\log \log n)\leqslant \mathcal{O}(\log n) \leqslant \mathcal{O}(\sqrt{n}) \leqslant \mathcal{O}(n) \leqslant \mathcal{O}(n\log n) \leqslant [\mathcal{O}({n^c}) \leqslant \mathcal{O}(c^n) \leqslant \ ] \mathcal{O}(n^2) \leqslant \mathcal{O}(2^n) \leqslant \mathcal{O}(2^{n^{2}}) \leqslant \mathcal{O}(n!) $
